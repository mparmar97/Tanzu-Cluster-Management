  ...
  router.route('/')
    .post(async (req, res) => {
      ...
      const getClusters = await axios
        .get('https://capgeminietap.tmc.cloud.vmware.com/v1alpha/clusters?query=spec.clusterGroupName%3A%27'.concat(clusterGroupName).concat('%27'),
          {
            headers: {
...
module.exports = routeGetClusters;
